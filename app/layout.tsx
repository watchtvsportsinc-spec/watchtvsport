...
export const metadata: Metadata = {
  ...
  description:
    "Find where to watch sports legally. Compare official TV channels and streaming platforms for football, Formula 1, UFC and more by event and country.",
  ...
  openGraph: {
    ...
    title: "WatchTVSport | Where to Watch Sports Worldwide",
    description: "Official sports TV and streaming information by event and country.",
    url: "/",
  },
  twitter: {
    card: "summary_large_image",
    title: "WatchTVSport | Where to Watch Sports Worldwide",
    description: "Find official sports broadcasters worldwide.",
  },
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div>
                <strong>WatchTVSport</strong>
                <p style={{ color: "#9fb0c3", lineHeight: 1.7 }}>
                  Le sport se regarde partout. Official broadcast information by event and territory.
                </p>
              </div>
              <div>
                <strong>Explore</strong>
                <p><Link href="/football" style={{ color: "#60a5fa" }}>Football</Link></p>
              ...
              <div>
                <strong>Trust & methodology</strong>
                <p style={{ color: "#9fb0c3", lineHeight: 1.7 }}>
                  Official broadcasters only. No illegal streams and no VPN circumvention guidance.
                </p>
                <p><Link href="/methodology" style={{ color: "#60a5fa" }}>How listings are verified</Link></p>
                <p><Link href="/report-error" style={{ color: "#60a5fa" }}>Report an error</Link></p>
              </div>
            </div>
            <div
              style={{
            ...
            >
              © 2026 WatchTVSport · Independent official broadcast guide
            </div>
          </footer>
        </div>
        <Analytics />
        ...
        <Script id="google-analytics" strategy="afterInteractive">
          {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag('js',new Date());gtag('config','G-2V9H3M35PT');`}
        </Script>
      </body>
    </html>
  );
