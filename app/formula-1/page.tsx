...
export default async function Formula1Page() {
  ...
  return <main id="main-content" className="v2-calendar">
    ...
    <section className="v2-calendar-hero wts-f1-hero" aria-labelledby="f1-title"><p className="v2-eyebrow">Motorsports · Championship</p><h1 id="f1-title">Formula 1</h1><p className="v2-hero-copy">Current Grand Prix weekends from verified event data. Open a Grand Prix for its published sessions and exact broadcaster information.</p></section>
