...
export async function generateMetadata({params}:PageProps):Promise<Metadata>{
 ...
 if(REDIRECTS[sport])return{title:"Redirecting | WatchTVSport",robots:{index:false,follow:true},alternates:{canonical:REDIRECTS[sport]}};
 if(!SUPPORTED.has(sport))return{title:"Sport not found | WatchTVSport",robots:{index:false,follow:false}};
