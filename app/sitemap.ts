...
export default function sitemap():MetadataRoute.Sitemap{
 ...
 const dedup=new Map<string,MetadataRoute.Sitemap[number]>();for(const entry of[...staticPages,...sportPages,...competitionPages,...clubPages,...nationPages,...permanentEventPages,...f1Pages,...ufcPages,...archiveMatchPages,...watchPages,...countryPages])dedup.set(entry.url,entry);return Array.from(dedup.values());
}
