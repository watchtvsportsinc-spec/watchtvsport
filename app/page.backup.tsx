  ...
  >
    ...
    >
      {[
        ...
        {
          title: "Which countries show World Cup matches for free?",
          text: "Several countries broadcast selected or all FIFA World Cup matches free-to-air. Availability depends on local broadcasting rights and official coverage agreements.",
        },
      ].map((item) => (
        <div
          key={item.title}
